...
import {
  ...
  FaShare, FaReply, FaEllipsisH, FaUndo, FaTrash, FaCopy, FaThumbtack, FaCrown, FaStar, FaEdit, FaHistory
} from 'react-icons/fa';
...
export const MessageBubble = ({
  ...
  // Avatar: chỉ dùng DEFAULT_AVATAR_SVG nếu không có ảnh thật — không dùng random service
  const avatarUrl = toAbsoluteUrl(sender?.avatarUrl || sender?.avatar);
  const avatar = avatarUrl || DEFAULT_AVATAR_SVG;
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mdc-msg-body">
          {/* Tên người gửi: CHỈ hiện trong nhóm, không hiện trong 1-1 */}
          {!isMe && isGroup && name && (
